            ...
            modelBuilder.Entity("Domain.Entites.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            InsertBy = 0,
                            InsertDate = new DateTime(2024, 10, 31, 1, 33, 18, 314, DateTimeKind.Local).AddTicks(1453),
                            IsActive = true,
                            IsDeleted = false,
                            RoleName = "SuperAdmin"
                        });
            ...
            modelBuilder.Entity("Domain.Entites.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "محمد",
                            InsertBy = 0,
                            InsertDate = new DateTime(2024, 10, 31, 1, 33, 18, 314, DateTimeKind.Local).AddTicks(3158),
                            IsDeleted = false,
                            LastName = "ضرابی",
            ...
            modelBuilder.Entity("Domain.Entites.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            InsertBy = 0,
                            InsertDate = new DateTime(2024, 10, 31, 1, 33, 18, 314, DateTimeKind.Local).AddTicks(4468),
                            IsDeleted = false,
                            RoleId = 1,
                            UserId = 1
                        });
